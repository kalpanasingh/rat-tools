# AlphaSeeded Coordinator
This folder contains the files needed to coordinate the Seeded Alpha classifier.  
...
- navigate to one directory up from this, and then do:
    ...
    python fitcoordinate [options] AlphaSeeded
...
The coordination results are written to screen - there will be a complete RATDB entry that should be placed in the CLASSIFIER_ALPHA_SEEDED.ratdb located in rat/data, replacing any existing entry with the same index.  
...
The coordination results are written to the Batch logfile - there will be a complete RATDB entry that should be placed in the CLASSIFIER_ALPHA_SEEDED.ratdb located in rat/data, replacing any existing entry with the same index.  
