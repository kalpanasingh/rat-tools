...
# Author P G Jones - 13/03/2011 <p.g.jones@qmul.ac.uk>
...
def ProduceRunMacros(options):
	...
	# Generate the specific macro for each position given in the Utilities table
    for position in Utilities.Positions:
	
        outfileName = "events_P=" + str(int(position)) + "mm"
