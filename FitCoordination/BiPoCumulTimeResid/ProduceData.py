...
def ProduceRunMacFiles(options):
    # produces and then runs the required RAT macro, and deletes the macro once complete
    ...
    outFile.close()
    print "Running " + fileName + ".mac and generating " + fileName + ".root"
    os.system("rat " + fileName + ".mac")
    os.remove(fileName + ".mac")
