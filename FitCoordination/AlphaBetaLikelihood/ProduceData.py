    ...
    for particleIndex, particle in enumerate(particleNames):
        ...
        for pulseIndex, pulseDescription in enumerate(Utilities.ParticlePulseDict[particle]):
            ...
            for run in range(10):
                ...
                outfileName = particle + pulseDescription + "_" + str(run+1)
...
if __name__ == '__main__':
    ...
    parser.add_option("-g", type = "string", dest = "geoFile", help = "Geometry File to use - location relative to rat/data/, default = geo/snoplus_te.geo", default = "geo/snoplus_te.geo")
    ...
    parser.add_option("-s", type = "string", dest = "scintMaterial", help = "Scintillator Material to use, default = te_0p3_labppo_scintillator_bisMSB_Feb2015", default = "te_0p3_labppo_scintillator_bisMSB_Feb2015")
