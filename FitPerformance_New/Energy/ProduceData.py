...
def ProduceRunMacros(options):
    ...
    for energyIndex, energy in enumerate(energyList):
        ...
        for yPosition in yPositionList:
            ...
            if (yPosition < 6005) and (options.scintMaterial != "lightwater_sno"):
                positionOptimiser = "powell"
                positionSelector = "null"
                positionPDF = "et1d"
                numberOfEventsList = list(numberOfEvents_scintillator)
            else:
                positionOptimiser = "metaDriveCorrectSeed-powell"
                positionSelector = "modeCut"
                positionPDF = "gv1d"
            ...
            outText1 = rawText1.substitute(ExtraDB = extraDB,
                                           ...
                                           PositionOptimiser = positionOptimiser,
        ...
        for zPosition in zPositionList:
            ...
            if (zPosition > -6005) and (zPosition < 6005) and (options.scintMaterial != "lightwater_sno"):
                positionOptimiser = "powell"
                positionSelector = "null"
                positionPDF = "et1d"
                numberOfEventsList = list(numberOfEvents_scintillator)
