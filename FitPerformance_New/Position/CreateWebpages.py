...
def CreateWebpages(options):
    ...
    if (options.fitterName2 == ""):
        pictureBaseName = "./PositionPerformance/images_" + options.scintMaterial + "/" + options.fitterName1 + "_"
    else:
        pictureBaseName = "./PositionPerformance/images_" + options.scintMaterial + "/" + options.fitterName1 + "+" + options.fitterName2 + "_"
    ...
    outFileName = "./PositionPerformance/" + options.scintMaterial + "_positionPerformance.html"
...
if __name__ == '__main__':
    ...
    parser.add_option("--f1", type = "string", dest = "fitterName1", help = "First Fitter to be Tested (name as specified in Template_Macro_Position.mac)", default = "")
    parser.add_option("--f2", type = "string", dest = "fitterName2", help = "(Optional) Second Fitter to be Tested (name as specified in Template_Macro_Position.mac)", default = "")
