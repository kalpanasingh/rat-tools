				  ...
				  Int_t fitNum )
{
  ...
  gExecTimeLegend->AddEntry( gExecTime, ShortFormName( lFit ).c_str(), "P" );
  reinterpret_cast< TGraph* >( vc1->FindObject( lFile.c_str() ) )->GetYaxis()->SetRangeUser( gMinExecutionTime, gMaxExecutionTime );
