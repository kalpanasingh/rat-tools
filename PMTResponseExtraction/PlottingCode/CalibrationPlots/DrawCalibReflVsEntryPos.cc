...
void
MakeCalibReflVsEntryPosGraphs(
			      vector<HitData*>& data,
			      vector<TH1D*> resultArray );
void
DrawCalibReflVsEntryPos(
		   vector<char*> files );
void
MakeResultVector(
		 vector<TH1D*>& resultArray,
		 ...
		 const bool directory )
{
  ...
  wave1->GetYaxis()->SetTitle( "Reflonse per 1 mm bin [%]");
  TH1D* wave2 = new TH1D( "wave2", "365nm Position Reflection", numBins, lowBin, highBin ); resultArray.push_back( wave2 );
  wave2->GetXaxis()->SetTitle( "Entry Position Radius [mm]");
  wave2->GetYaxis()->SetTitle( "Reflection per 1 mm bin [%]");
  TH1D* wave3 = new TH1D( "wave3", "386nm Position Reflection", numBins, lowBin, highBin ); resultArray.push_back( wave3 );
  wave3->GetXaxis()->SetTitle( "Entry Position Radius [mm]");
  wave3->GetYaxis()->SetTitle( "Reflection per 1 mm bin [%]");
  TH1D* wave4 = new TH1D( "wave4", "420nm Position Reflection", numBins, lowBin, highBin ); resultArray.push_back( wave4 );
  wave4->GetXaxis()->SetTitle( "Entry Position Radius [mm]");
  wave4->GetYaxis()->SetTitle( "Reflection per 1 mm bin [%]");
  TH1D* wave5 = new TH1D( "wave5", "500nm Position Reflection", numBins, lowBin, highBin ); resultArray.push_back( wave5 );
  wave5->GetXaxis()->SetTitle( "Entry Position Radius [mm]");
  wave5->GetYaxis()->SetTitle( "Reflection per 1 mm bin [%]");
  TH1D* wave6 = new TH1D( "wave6", "620nm Position Reflection", numBins, lowBin, highBin ); resultArray.push_back( wave6 );
  wave6->GetXaxis()->SetTitle( "Entry Position Radius [mm]");
  wave6->GetYaxis()->SetTitle( "Reflection per 1 mm bin [%]");
  if( directory == false )
    {
		   ...
		   vector<char*> files )
{
  ...
  if( files.empty() == true ) // Load from filesFullData
      ...
      for( uLoop = 0; uLoop < filesFullData.size(); uLoop++ )
	{
	  ...
	  MakeCalibReflVsEntryPosGraphs( current, resultPlots );
  ...
  c2->Divide( 3, 2 );
  c2->cd(1);
  ratios[1][0]->SetTitle( "337nm Position Reflection Ratio" );
  ratios[1][0]->GetYaxis()->SetRangeUser( 0.8, 1.2 );
  ratios[1][0]->GetYaxis()->SetTitle( "Reflection ratio per 1 mm bin" );
  ratios[1][0]->Draw("E"); // At least 1 result
  c2->cd(2);
  ratios[1][1]->SetTitle( "365nm Position Reflection Ratio" );
  ratios[1][1]->GetYaxis()->SetRangeUser( 0.8, 1.2 );
  ratios[1][1]->GetYaxis()->SetTitle( "Reflection ratio per 1 mm bin" );
  ratios[1][1]->Draw("E"); // At least 1 result
  c2->cd(3);
  ratios[1][2]->SetTitle( "386nm Position Reflection Ratio" );
  ratios[1][2]->GetYaxis()->SetRangeUser( 0.8, 1.2 );
  ratios[1][2]->GetYaxis()->SetTitle( "Reflection ratio per 1 mm bin" );
  ratios[1][2]->Draw("E"); // At least 1 result
  c2->cd(4);
  ratios[1][3]->SetTitle( "420nm Position Reflection Ratio" );
  ratios[1][3]->GetYaxis()->SetRangeUser( 0.8, 1.2 );
  ratios[1][3]->GetYaxis()->SetTitle( "Reflection ratio per 1 mm bin" );
  ratios[1][3]->Draw("E"); // At least 1 result
  c2->cd(5);
  ratios[1][4]->SetTitle( "500nm Position Reflection Ratio" );
  ratios[1][4]->GetYaxis()->SetRangeUser( 0.8, 1.2 );
  ratios[1][4]->GetYaxis()->SetTitle( "Reflection ratio per 1 mm bin" );
  ratios[1][4]->Draw("E"); // At least 1 result
  c2->cd(6);
  ratios[1][5]->SetTitle( "620nm Position Reflection Ratio" );
  ratios[1][5]->GetYaxis()->SetRangeUser( 0.8, 1.2 );
  ratios[1][5]->GetYaxis()->SetTitle( "Reflection ratio per 1 mm bin" );
