...
void
MakeEntryPosDistVsAngleGraphs(
		      vector<HitData*>& data,
		      vector<TH1D*> resultArray );
void
DrawEntryPosDistVsAngle(
			 vector<char*> files);
void
MakeEntryPosResultVector(
		 vector<TH1D*>& resultArray,
			  ...
			  const bool directory )
{
  ...
  numBins = 150; lowBin = 0.0;  highBin = 150.0;
		      ...
		      vector<TH1D*> resultArray ) 
{
  ...
  MakeEntryPosResultVector( signalArray, false );
